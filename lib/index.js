...
class WhatsAppAPI {
  ...
  async sendMessage(phoneID, recipient, message, context, biz_opaque_callback_data) {
    ...
    const request = {
      ...
      type,
      [type]: message,
      recipient: individual ? r.bsuid : void 0,
  ...
  async post(data, raw_body, signature) {
    ...
    if (field === "messages") {
      if (field in value) {
        ...
        const recipient = {
          phone: !group_id ? wa_id : void 0,
          bsuid: !group_id ? parent_user_id ?? user_id : void 0,
          group: group_id
        };
        const args = {
          phoneID,
        ...
        const recipient = {
          phone: !is_group ? wa_id : void 0,
          bsuid: !is_group ? parent_user_id ?? user_id : void 0,
          group: is_group ? recipient_id : void 0
        };
        const args = {
          phoneID,
          // TODO: Remove in v7
