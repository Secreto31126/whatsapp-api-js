...
class Template extends import_types.ClientMessage {
  /**
...
class MPMComponent extends ButtonComponent {
   ...
   * @internal
   */
  static Action = class extends import_types.ClientLimitedMessageComponent {
    type = "action";
    action;
    /**
...
class CarouselComponent extends import_types.ClientLimitedMessageComponent {
  /**
   * The type of the component
   */
  type = "carousel";
