...
class Contacts extends ClientMessage {
  /**
...
class Address extends ContactMultipleComponent {
  /**
...
class Birthday extends ContactUniqueComponent {
  /**
...
class Email extends ContactMultipleComponent {
  /**
...
class Name extends ContactUniqueComponent {
  /**
...
class Organization extends ContactUniqueComponent {
  /**
...
class Phone extends ContactMultipleComponent {
  /**
...
class Url extends ContactMultipleComponent {
  /**
