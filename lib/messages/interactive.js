...
class Interactive extends ClientMessage {
  /**
...
class ActionButtons extends ClientLimitedMessageComponent {
  /**
...
class ActionList extends ClientLimitedMessageComponent {
  /**
   * The button text
   */
  button;
...
class ActionProductList extends ClientLimitedMessageComponent {
  /**
   * The id of the catalog from where to get the products
   */
  catalog_id;
