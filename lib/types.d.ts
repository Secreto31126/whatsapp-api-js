...
export type ClientRecipientIdentifier = ClientIndividualRecipientIdentifier | ClientGroupRecipientIdentifier;
/**
...
export type ServerInteractiveMessage = {
    type: "interactive";
    interactive: ServerInteractiveButtonMessage | ServerInteractiveListMessage | ServerInteractiveNFMMessage | ServerInteractiveCallPermissionMessage;
};
...
export type ServerSystemMessage = {
    ...
    system: {
        ...
        type: "customer_changed_number" | "customer_identity_changed" | "user_changed_user_id" | "user_changed_number" | string /** @deprecated Backwards compatibility */;
        customer?: string;
    };
};
...
export type ServerPreacceptCallResponse = (ServerSuccessResponse & {
    messaging_product: "whatsapp";
}) | ServerErrorResponse;
export type ServerRejectCallResponse = (ServerSuccessResponse & {
    messaging_product: "whatsapp";
}) | ServerErrorResponse;
export type ServerAcceptCallResponse = (ServerSuccessResponse & {
    messaging_product: "whatsapp";
}) | ServerErrorResponse;
export type ServerTerminateCallResponse = (ServerSuccessResponse & {
    messaging_product: "whatsapp";
}) | ServerErrorResponse;
...
export type ServerGroupField = "join_approval_mode" | "subject" | "description" | "suspended" | "creation_timestamp" | "participants" | "total_participant_count";
...
export type ServerRetrieveGroupResponse = ({
    messaging_product: "whatsapp";
} & ServerGroup & NoServerError) | ServerErrorResponse;
