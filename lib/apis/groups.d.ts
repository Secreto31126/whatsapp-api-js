import type { ClientGroupJoinApprovalMode, ClientIndividualRecipientIdentifier, ServerGroupField, ServerCreateGroupResponse, ServerRetrieveGroupsResponse, ServerRetrieveGroupResponse, ServerUpdateGroupResponse, ServerDeleteGroupResponse, ServerGroupInviteLinkResponse, ServerRemoveGroupParticipantsResponse, ServerRetrieveGroupJoinRequestsResponse, ServerApproveGroupJoinRequestsResponse, ServerRejectGroupJoinRequestsResponse } from "../types.d.ts";
...
export interface API {
     ...
     */
    createGroup(phoneID: string, subject: string, description?: string, joinApprovalMode?: ClientGroupJoinApprovalMode): Promise<ServerCreateGroupResponse>;
    /**
     ...
     */
    updateGroupPicture(groupID: string, form: unknown, check?: boolean): Promise<ServerUpdateGroupResponse>;
    /**
     * Delete a group
     *
     * @beta
     ...
     */
    removeGroupParticipants(groupID: string, ...users: AtLeastOne<ClientIndividualRecipientIdentifier>): Promise<ServerRemoveGroupParticipantsResponse>;
    /**
